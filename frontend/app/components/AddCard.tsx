    ...
    return (
        <form onSubmit={submitToDict}>
            <div className="row mb-3">
                ...
                <div className="col">
                    <label htmlFor="translationInput" className="form-label">Translation</label>
                    <input
                        type="text"
                        className="form-control"
                        id="translationInput"
            ...
            <div className="row mb-3 mt-4 mx-0">
                Examples
            </div>
            {examples.map((example, idx) => (
                <div className="row mb-3" key={idx}>                    
                    ...
                    <div className="col">
                        <input type="text" className="form-control" value={example.translation} placeholder="Translation" readOnly />
                    </div>
                </div>
            ))}
            {isAlertExamples && (
            ...
            <div className="row mb-3 mt-5">
                <div className="col">
                    <button type="button" className="btn btn-secondary w-100" onClick={generateExamples}>Ask ChatGPT for Examples</button>
                </div>
                <div className="col">
                    <button type="button" className="btn btn-secondary w-100" onClick={addExample}>Add Example</button>
                </div>
            </div>
            <div className="row mb-3">
                <div className="col">
